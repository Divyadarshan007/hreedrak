  ...
  const productCategories = [
    {
      ...
      subItems: [
        ...
        { name: 'Gel Lithium Heparin', href: '/products/vacuum-blood-collection-tubes/gel-lithium-heparin-vacuum-blood-collection-tube' },
        { name: 'Lithium Heparin', href: '/products/vacuum-blood-collection-tubes/lithium-heparin-vacuum-blood-collection-tube' },
        { name: 'Sodium Heparin', href: '/products/vacuum-blood-collection-tubes/sodium-heparin-vacuum-blood-collection-tube' },
        { name: 'Sodium Citrate 3.2%', href: '/products/vacuum-blood-collection-tubes/sodium-citrate-3-2-vacuum-blood-collection-tube' },
        { name: 'Sodium Citrate 3.8%', href: '/products/vacuum-blood-collection-tubes/sodium-citrate-3-8-vacuum-blood-collection-tube' },
      ],
    },
    {
      ...
      subItems: [
        ...
        { name: 'Gel Lithium Heparin', href: '/products/non-vacuum-blood-collection-tubes/gel-lithium-heparin-non-vacuum-blood-collection-tube' },
        { name: 'Lithium Heparin', href: '/products/non-vacuum-blood-collection-tubes/lithium-heparin-non-vacuum-blood-collection-tube' },
        { name: 'Sodium Heparin', href: '/products/non-vacuum-blood-collection-tubes/sodium-heparin-non-vacuum-blood-collection-tube' },
        { name: 'Sodium Citrate 3.2%', href: '/products/non-vacuum-blood-collection-tubes/sodium-citrate-3-2-non-vacuum-blood-collection-tube' },
        { name: 'Sodium Citrate 3.8%', href: '/products/non-vacuum-blood-collection-tubes/sodium-citrate-3-8-non-vacuum-blood-collection-tube' },
      ],
    },
    {
