...
const productCategories = {
  vacuum: [
    ...
    { id: 4, name: 'Sodium Fluoride Vacuum Blood Collection Tube', image: '/productImage/vaccum_tubes/fluoride-vacuum-blood-collection-tube-1740496500-7886414.jpg', price: '₹2.75 – ₹4.00 / piece', moq: '5000 piece', slug: 'fluoride-vacuum-blood-collection-tube', categorySlug: 'vacuum-blood-collection-tubes' },
  ...
  nonVacuum: [
    { id: 6, name: 'Sodium Fluoride Non-Vacuum Blood Collection Tube', image: '/productImage/non_vaccum_tubes/fluoride-safety-cap-blood-collection-tube-1740581900-7886495.jpg', price: '₹1.40 – ₹1.80 / piece', moq: '10000 piece', slug: 'blood-collection-flouride-tube-with-double-safety-caps', categorySlug: 'non-vacuum-blood-collection-tubes' },
    ...
    { id: 8, name: 'K2 EDTA Non-Vacuum Blood Collection Tube', image: '/productImage/non_vaccum_tubes/k2-edta-safety-cap-blood-collection-tube-1740580690-7886490.jpg', price: '₹1.40 – ₹1.80 / piece', moq: '10000 piece', slug: 'k2-edta-safety-cap-blood-collection-tube', categorySlug: 'non-vacuum-blood-collection-tubes' },
    { id: 9, name: '⁠K3 EDTA Non-Vacuum Blood Collection Tube', image: '/productImage/non_vaccum_tubes/k3-edta-safety-cap-blood-collection-tube-1740580332-7886474.jpg', price: '₹1.40 – ₹1.80 / piece', moq: '10000 piece', slug: 'k3-edta-safety-cap-blood-collection-tube', categorySlug: 'non-vacuum-blood-collection-tubes' },
  ...
  singleCap: [
    { id: 11, name: 'Clot Activator Blood Collection Tube', image: '/productImage/single_cap_tubes/single-cap-clot-activator-blood-collection-tube-1740497900-7886439.jpg', price: '₹1.20 – ₹1.60 / piece', moq: '12000 piece', slug: 'clot-activator-single-cap-blood-collection-tube', categorySlug: 'single-cap-blood-collection-tubes' },
    { id: 12, name: 'Sodium Fluoride Blood Collection Tube', image: '/productImage/single_cap_tubes/fluoride-single-cap-blood-collection-tube-1740498240-7886448.jpg', price: '₹1.20 – ₹1.60 / piece', moq: '12000 piece', slug: 'fluoride-single-cap-blood-collection-tube', categorySlug: 'single-cap-blood-collection-tubes' },
    { id: 13, name: 'K2 EDTA Blood Collection Tube', image: '/productImage/single_cap_tubes/k2-edta-single-cap-blood-collection-tube-1740497396-7886431.jpg', price: '₹1.20 – ₹1.60 / piece', moq: '12000 piece', slug: 'k2-edta-non-vacuum-blood-collection-tube', categorySlug: 'single-cap-blood-collection-tubes' },
    { id: 14, name: 'K3 EDTA Blood Collection Tube', image: '/productImage/single_cap_tubes/k3-edta-single-cap-tube-1740497811-7886427.jpg', price: '₹1.20 – ₹1.60 / piece', moq: '12000 piece', slug: 'k3-edta-single-cap-non-vacuum-blood-collection-tube', categorySlug: 'single-cap-blood-collection-tubes' },
