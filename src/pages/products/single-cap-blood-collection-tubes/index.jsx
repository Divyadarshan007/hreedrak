    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="bg-blue-50 border-b border-blue-100 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900">Single Cap Blood Collection Tubes</h1>
        </div>
      </div>
      ...
      <div className="bg-gray-50 border-b border-gray-100 py-3">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-2 text-xs text-gray-500">
            ...
            <span className="text-gray-700 font-medium">Single Cap Blood Collection Tubes</span>
          </nav>
        </div>
      </div>
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10">
        ...
        <p className="text-gray-400 text-sm mb-6">Showing all {singleCapProducts.length} results</p>
