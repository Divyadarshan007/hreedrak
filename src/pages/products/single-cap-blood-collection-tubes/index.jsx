...
const singleCapProducts = getProductsByCategory('single-cap-blood-collection-tubes')


const SingleCapBloodCollectionTubes = () => {
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #034DA2 0%, #023585 55%, #231F20 100%)' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 text-center relative">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-white uppercase tracking-tight">Non-vacuum Single Cap Blood Collection Tube</h1>
        </div>
      </div>
      ...
      <div className="bg-gray-50 border-b border-gray-100 py-3">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-2 text-xs text-gray-500">
            ...
            <span className="text-gray-900 font-semibold uppercase tracking-wider">Non-vacuum Single Cap Blood Collection Tube</span>
          </nav>
        </div>
      </div>
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          <div>
            ...
            <p className="text-gray-500 font-medium tracking-wide italic">Showing all {singleCapProducts.length} high-quality results</p>
          </div>
...
export default SingleCapBloodCollectionTubes
