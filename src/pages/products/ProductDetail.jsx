          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="relative flex-shrink-0 mt-0.5" ref={shareRef}>
                  <button
                  ...
                  {showShare && (
                    <div className="absolute right-0 top-7 z-50 bg-white border border-gray-200 rounded-xl shadow-xl w-52 py-2 text-sm">
                      <p className="px-4 py-1.5 text-xs font-semibold text-gray-400 uppercase tracking-wide">Share via</p>
                      {/* WhatsApp */}
                      <a
                      ...
                      <button
                        ...
                        className="flex items-center gap-3 px-4 py-2 hover:bg-gray-50 text-gray-700 w-full transition-colors"
                      >
        ...
        <div id="enquiry-form" className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 mb-6">
          ...
          <form onSubmit={handleSubmit} noValidate className="max-w-2xl mx-auto space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="text-sm text-gray-500 mb-1 block">Quantity <span className="text-red-500">*</span></label>
                <div className="flex gap-2">
                  <input
                    name="quantity"
                    value={form.quantity}
                    ...
                    className={`flex-1 border rounded px-3 py-2 text-sm focus:outline-none focus:border-primary ${errors.quantity ? 'border-red-400' : 'border-gray-300'}`}
                  />
