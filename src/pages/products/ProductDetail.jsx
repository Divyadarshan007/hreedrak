      ...
      <main className="flex-1">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
          ...
          <div className="mb-8 pb-6 border-b border-gray-100">
            ...
            <h1 className="text-2xl sm:text-3xl font-extrabold leading-snug mb-2" style={{ color: FONT }}>
              {product.name}
            </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
            ...
            <div className="lg:w-[360px] flex-shrink-0 lg:sticky lg:top-8 self-start">
              ...
              {/* Share */}
              <div className="mt-5 relative" ref={shareRef}>
                <button
                ...
                {showShare && (
                  <div className="absolute z-50 bg-white border border-gray-200 rounded-xl shadow-xl w-52 py-2 text-sm" style={{ top: 'calc(100% + 8px)', left: '0' }}>
