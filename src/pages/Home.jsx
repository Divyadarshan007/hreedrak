  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 w-10 h-10 bg-primary hover:bg-primary-dark rounded-full flex items-center justify-center shadow-lg transition-colors"
        title="Scroll to top"
      >
